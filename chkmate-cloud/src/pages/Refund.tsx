    ...
    <div className="bg-slate-950 min-h-screen text-slate-300">
      ...
      <div className="pt-24 pb-16">
        <Section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-slate-50 mb-8">Refund Policy</h1>
          <div className="prose prose-invert prose-slate max-w-none">
            <p className="text-sm text-slate-400 mb-8">Last Updated: {new Date().toLocaleDateString()}</p>

            <h2 className="text-2xl font-semibold text-slate-50 mt-8 mb-4">1. Satisfaction Guarantee</h2>
            <p className="mb-4">
              We stand behind our products and services. If you are not completely satisfied with your purchase, please contact us.
            </p>

            <h2 className="text-2xl font-semibold text-slate-50 mt-8 mb-4">2. Paddle.com</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-slate-50 mt-8 mb-4">3. Refund Eligibility</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-slate-50 mt-8 mb-4">4. Processing Refunds</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-slate-50 mt-8 mb-4">5. Contact Us</h2>
            <p className="mb-4">
