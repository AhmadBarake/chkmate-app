      ...
      <div className="pt-24 pb-16">
        <Section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Payment Processing</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">6. Your Rights (GDPR)</h2>
            <p className="mb-4">
